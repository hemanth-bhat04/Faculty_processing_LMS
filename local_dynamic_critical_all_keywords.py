...
class DataBase:
    ...
    def __init__(self):
        ...
        self._dbname = "inet_client[Pi_Ruby]"
        self._password = "Aravindsri@25"
        self._port = "5432"
        self._user = "postgres"
    ...
    def get_video_ids(self, five_min_table: str = "private_videomaster_m_6", limit: int = None) -> list:
    ...
    def get_5min_keywords(self, video_id: str, five_min_table: str = "private_videomaster_m_6") -> list:
        ...
        query = "SELECT critical_1m_keywords from " + five_min_table + \
                " WHERE video_id='%s' and critical_1m_keywords is not null ORDER BY _offset" % video_id
        cursor.execute(query)
    ...
    def get_critical_all_keywords(self, five_min_table: str = "private_videomaster_m_6", limit: int = None) -> list:
    ...
    def update_critical_all_keywords(self, video_id: str, critical_all_keywords: list,
                                      five_min_table: str = "private_videomaster_m_6") -> None:
